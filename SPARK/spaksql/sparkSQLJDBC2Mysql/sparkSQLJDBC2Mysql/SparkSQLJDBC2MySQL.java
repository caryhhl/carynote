	...
	public static void main(String[] args) {
		...
		JavaPairRDD<String, Tuple2<Integer, Integer>>  resultRDD = dtsparkDataSourceDFFromMysql.javaRDD().mapToPair(new PairFunction<Row, String, Integer>() {
			...
			public Tuple2<String, Integer> call(Row row) throws Exception {
				...
				return new Tuple2<String, Integer>((String) row.getAs("name"), (int) row.getAs("score"));
			}
			...
			@Override
			public Tuple2<String, Integer> call(Row row) throws Exception {
				return new Tuple2<String, Integer>((String) row.getAs("name"), (int) row.getAs("age"));
			}
		}));
