...
public class SparkSQLwithJoin {
	public static void main(String[] args) {
		...
		DataFrame peoplesDF = sqlContext.read().json("D:\\Big_Data_Software"
				+ "\\spark-1.6.1-bin-hadoop2.6\\examples\\src\\main\\resources\\peoples.json");
		...
		personsDF.write().format("json").save("D:\\Big_Data_Software"
				+ "\\spark-1.6.1-bin-hadoop2.6\\examples\\src\\main\\resources\\peopleresult");
